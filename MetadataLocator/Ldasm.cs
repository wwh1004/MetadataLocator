...
unsafe struct Ldasm {
	...
	static readonly byte[] flags_table = new byte[256] {
		/* 00 */    OP_MODRM,
		/* 01 */    OP_MODRM,
		/* 02 */    OP_MODRM,
		/* 03 */    OP_MODRM,
	...
	static readonly byte[] flags_table_ex = new byte[256] {
		/* 0F00 */    OP_MODRM,
		/* 0F01 */    OP_MODRM,
		/* 0F02 */    OP_MODRM,
		/* 0F03 */    OP_MODRM,
	...
	public uint ldasm(nuint code, bool is64) {
		byte* p = (byte*)code;
		byte s, op, f;
