...
public sealed unsafe class MetadataImport {
	...
	static readonly Profile[] profiles = {
		new(new(0xce0f34ed, 0xbbc6, 0x11d2, 0x94, 0x1e, 0x00, 0x00, 0xf8, 0x08, 0x34, 0x60), 102), // fx20 ~ net31
		new(new(0x1b119f60, 0xc507, 0x4024, 0xbb, 0x39, 0xf8, 0x22, 0x3f, 0xb3, 0xe1, 0xfd), 92) // net50+
	};
